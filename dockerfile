...
RUN wget -O /tmp/DownloadYouTubePlex.tar.gz https://github.com/awirthy/DownloadYouTubePlex/archive/refs/tags/v0.16.0.tar.gz
...
RUN echo "/opt/DownloadYouTubePlex/DownloadYouTubePlex-0.16.0/DownloadYouTubePlex.sh" >> /etc/periodic/15min/DownloadYouTubePlex
RUN chmod 755 /opt/DownloadYouTubePlex/DownloadYouTubePlex-0.16.0/DownloadYouTubePlex.sh
